...
/**
 * AuthorizedUserAssignment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizedUserAssignment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizedUserAssignment';
    ...
    */
     ...
     * Sets user
     *
     * @param string $user The user that is authorized
     *
     * @return self
     */
     ...
     * Sets tenant
     *
     * @param string $tenant The tenant that the user is authorized for
     *
     * @return self
     */
     ...
     * Sets resource
     *
     * @param string $resource The resource that the user is authorized for
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string $role The role that the user is assigned to
     *
     * @return self
     */
