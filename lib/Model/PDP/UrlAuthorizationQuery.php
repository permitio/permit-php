...
/**
 * UrlAuthorizationQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class UrlAuthorizationQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UrlAuthorizationQuery';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $url when calling UrlAuthorizationQuery., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling UrlAuthorizationQuery., must be bigger than or equal to 1.');
        }
