...
/**
 * AllTenantsAuthorizationResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AllTenantsAuthorizationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_AllTenantsAuthorizationResult';
    ...
    {
        $this->setIfExists('allow', $data ?? [], false);
        $this->setIfExists('query', $data ?? [], null);
        $this->setIfExists('debug', $data ?? [], null);
        $this->setIfExists('result', $data ?? [], false);
    ...
    */
     ...
     * Gets tenant
     *
     * @return \OpenAPI\Client\Model\TenantDetails
     */
     ...
     * Sets tenant
     *
     * @param \OpenAPI\Client\Model\TenantDetails $tenant tenant
     *
     * @return self
     */
