...
class FullData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets users
     *
     * @param array<string,\OpenAPI\Client\Model\UserData> $users users
     *
     * @return self
     */
     ...
     * Sets roles
     *
     * @param array<string,\OpenAPI\Client\Model\RoleData> $roles roles
     *
     * @return self
     */
     ...
     *
     * @param array<string,array<string,array<string,string[]>>> $condition_set_rules condition_set_rules
     *
     * @return self
     */
