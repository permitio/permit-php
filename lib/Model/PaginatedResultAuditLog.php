...
/**
 * PaginatedResultAuditLog Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedResultAuditLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedResult_AuditLog_';
    ...
    */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling PaginatedResultAuditLog., must be bigger than or equal to 0.');
        }
    ...
    public function setPageCount($page_count)
    {
        ...
        if (!is_null($page_count) && ($page_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_count when calling PaginatedResultAuditLog., must be bigger than or equal to 0.');
        }
