...
{
    public const DISCRIMINATOR = 'actor_type';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['actor_type'] = static::$openAPIModelName;
    }
    ...
    */
    ...
    {
        $allowedValues = $this->getIsOnboardingAllowableValues();
        if (!in_array($is_onboarding, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'is_onboarding', must be one of '%s'",
                    $is_onboarding,
     ...
     *
     * @param string $onboarding_step onboarding_step
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getOnboardingStepAllowableValues();
        if (!in_array($onboarding_step, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'onboarding_step', must be one of '%s'",
                    $onboarding_step,
